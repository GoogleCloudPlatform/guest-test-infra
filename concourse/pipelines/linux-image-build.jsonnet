          ...
          imgpublishjob {
            ...
            extra_test_tasks: [
              common.imagetesttask {
                ...
                extra_args:: [ '-compute_endpoint_override=https://www.googleapis.com/compute/alpha/', '-use_reservations=true', '-reservation_urls=image-exfr-2', '-x86_shape=a3-ultragpu-8g', '-zone=europe-west1-b' ],
              },
            ],
          }
          for env in envs
