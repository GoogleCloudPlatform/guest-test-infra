...

{
  ...
  resources: [
               ...
               },
               {
                 ...
                 type: 'time',
                 source: { start: '4:30 AM', stop: '5:00 AM', location: 'America/Los_Angeles', days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'], initial_version: true },
               },
               {
                 name: 'time-rocky-linux-9-optimized-gcp-nvidia-570',
                 type: 'time',
                 source: { start: '6:00 AM', stop: '6:30 AM', location: 'America/Los_Angeles', days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'], initial_version: true },
               },
               {
                 name: 'time-rocky-linux-9-optimized-gcp-nvidia-latest',
                 type: 'time',
                 source: { start: '7:30 AM', stop: '8:00 AM', location: 'America/Los_Angeles', days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'], initial_version: true },
               },
