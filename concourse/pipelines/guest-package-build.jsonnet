            ...
            config: {
              ...
              run: {
                ...
                args: [
                  '-project=gcp-guest',
                  '-zone=us-central1-a',
                  '-exclude=licensevalidation',  // At time of writing, licensevalidation only validates image metadata not image behavior so not relevant for package testing
    ...
    buildpackagejob {
      ...
      uploads: [
        ...
        uploadpackageversiontask {
          ...
          pkg_version: '((.:package-version))',
          reponame: 'dnf-plugin-artifact-registry',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.x86_64.rpm"',
          os_type: 'EL8_X86_64_YUM',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.aarch64.rpm"',
          os_type: 'EL8_AARCH64_YUM',
          pkg_inside_name: 'dnf-plugin-artifact-registry',
          pkg_name: 'artifact-registry-yum-plugin',
          pkg_version: '((.:package-version))',
          reponame: 'dnf-plugin-artifact-registry-el8',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el9.x86_64.rpm"',
          os_type: 'EL9_X86_64_YUM',
          pkg_inside_name: 'dnf-plugin-artifact-registry',
          pkg_name: 'artifact-registry-yum-plugin',
          pkg_version: '((.:package-version))',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el9.aarch64.rpm"',
          os_type: ' EL9_AARCH64_YUM',
          pkg_inside_name: 'dnf-plugin-artifact-registry',
          pkg_name: 'artifact-registry-yum-plugin',
          pkg_version: '((.:package-version))',
          reponame: 'dnf-plugin-artifact-registry-el9',
    ...
    buildpackagejob {
      ...
      uploads: [
        ...
        uploadpackageversiontask {
          ...
          os_type: ' WINDOWS10_X86_GOOGET',
          pkg_inside_name: 'certgen',
          pkg_name: 'compute-image-windows',
          pkg_version: '((.:package-version))',
          reponame: 'certgen',
          sbom_file: 'gs://gcp-guest-package-uploads',
        },
        uploadpackageversiontask {
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/google-compute-engine-sysprep.noarch.((.:package-version))@1.goo"',
          os_type: ' OSTYPE_UNSPECIFIED',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/compute-image-windows/google-compute-engine-ssh.x86_64.((.:package-version)).0@1.goo"',
          os_type: ' WINDOWS10_X86_GOOGET',
