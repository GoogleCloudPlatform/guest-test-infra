  ...
  jobs: [
    ...
    buildpackagejob {
      ...
      uploads: [
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/dnf-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.x86_64.rpm","gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.aarch64.rpm"',
          os_type: 'EL8_YUM',
          ...
          sbom_file: 'gs://gcp-guest-package-uploads/dnf-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version)).sbom.json',
        },
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/dnf-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el9.x86_64.rpm","gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.aarch64.rpm"',
          os_type: 'EL9_YUM',
          pkg_inside_name: 'dnf-plugin-artifact-registry',
          pkg_name: 'artifact-registry-dnf-plugin',
          pkg_version: '((.:package-version))',
