...
local build_guest_agent = buildpackagejob {
  ...
  local x86PartnerImagesToTest = [
    ...
    'projects/guest-package-builder/global/images/sles-15-sp4-byos-((.:build-id))',
      ...
      in_parallel: {
        steps: [
          buildpackageimagetaskwindows {
            ...
            gcs_package_path: '"gs://gcp-guest-package-uploads/%s/google-compute-engine-windows.x86_64.((.:package-version)).0@1.goo","gs://gcp-guest-package-uploads/%s/google-compute-engine-metadata-scripts.x86_64.((.:package-version)).0@1.goo"' % [tl.package, tl.package],
          },
          buildpackageimagetaskwindows {
