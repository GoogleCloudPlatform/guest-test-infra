            ...
            config: {
              ...
              run: {
                ...
                args: [
                  ...
                  '-exclude=(mdsmtls)|(image)|(livemigrate)|(suspendresume)|(disk)|(security)|(oslogin)|(storageperf)|(networkperf)|(shapevalidation)|(hotattach)|(licensevalidation)',
                  '-parallel_count=15',
                ],
              },
            },
            ...
            config: {
              ...
              run: {
                ...
                args: [
                  ...
                  '-exclude=(mdsmtls)|(image)|(suspendresume)|(livemigrate)|(disk)|(security)|(oslogin)|(storageperf)|(networkperf)|(shapevalidation)|(hotattach)|(licensevalidation)',
                  '-parallel_count=15',
                ],
              },
            },
