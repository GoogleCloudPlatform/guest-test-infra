  ...
  jobs: [
    ...
    buildpackagejob {
      ...
      uploads: [
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://osconfig/google-osconfig-agent-((.:package-version))-g1.el7.x86_64.rpm"',
          os_type: 'EL7_YUM',
          pkg_inside_name: 'google-osconfig-agent',
          pkg_name: 'google-osconfig-agent',
          pkg_version: '((.:package-version))',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://osconfig/google-osconfig-agent-((.:package-version))-g1.el8.x86_64.rpm","gs://osconfig/google-osconfig-agent-((.:package-version))-g1.el8.aarch64.rpm"',
          os_type: 'EL8_YUM',
          pkg_inside_name: 'google-osconfig-agent',
          pkg_name: 'google-osconfig-agent',
          pkg_version: '((.:package-version))',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://osconfig/google-osconfig-agent-((.:package-version))-g1.el9.x86_64.rpm","gs://osconfig/google-osconfig-agent-((.:package-version))-g1.el9.aarch64.rpm"',
          os_type: 'EL9_YUM',
          pkg_inside_name: 'google-osconfig-agent',
          pkg_name: 'google-osconfig-agent',
          pkg_version: '((.:package-version))',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://osconfig/google-osconfig-agent.x86_64.((.:package-version)).0+win@1.goo"',
          os_type: 'WINDOWS_ALL_GOOGET',
          pkg_inside_name: 'google-osconfig-agent',
          pkg_name: 'google-osconfig-agent',
          pkg_version: '((.:package-version))',
    ...
    buildpackagejob {
      ...
      uploads: [
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.x86_64.rpm","gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.aarch64.rpm"',
          os_type: 'EL8_YUM',
        ...
        uploadpackageversiontask {
          gcs_files: '"gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el9.x86_64.rpm","gs://gcp-guest-package-uploads/google-compute-engine/yum-plugin-artifact-registry/dnf-plugin-artifact-registry-((.:package-version))-g1.el8.aarch64.rpm"',
          os_type: 'EL9_YUM',
          pkg_inside_name: 'dnf-plugin-artifact-registry',
          pkg_name: 'artifact-registry-dnf-plugin',
          pkg_version: '((.:package-version))',
